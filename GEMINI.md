...
## 향후 계획 (Next Steps)
- [ ] **React로 전환**: Vanilla JS 환경에서 React + React Three Fiber(R3F) 환경으로 마이그레이션하여 UI 연동 및 확장성 확보.
- [ ] **모델 뷰어 고도화**: 업로드된 학교 모델링 파일의 조명 및 텍스처 최적화.
- [ ] **강의실 정보 연동**: 모델 내 특정 객체 클릭 시 강의실 정보를 표시하는 기능 구현.
